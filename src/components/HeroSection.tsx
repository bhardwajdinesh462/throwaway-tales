    ...
    <section className="relative min-h-[90vh] pt-28 pb-16 overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 mb-8 backdrop-blur-sm animate-fade-in [animation-delay:100ms]">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-[1.1] tracking-tight animate-fade-in [animation-delay:150ms]">
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-16 animate-fade-in [animation-delay:350ms]">
