  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main>
        ...
        {/* Real-time Inbox Header + Quick Tips - Below Email Generator */}
        <section className="py-12 relative">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col xl:flex-row gap-8 items-start">
              ...
              {/* Quick Tips Card - Right Side */}
              <motion.div 
                className="xl:w-96 w-full relative overflow-hidden rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 via-background to-accent/10 p-6 shadow-lg shadow-primary/5"
